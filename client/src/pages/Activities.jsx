...
const Activities = () => {
    ...
    const smallClass = useRef('backgroundImg-Activities-small');
    ...
    return (
        <>
            <main id='main' className='App-backMaxHeight'>
                <section ref={imgContainer} className={`App-backImg ${smallClass.current} backgroundImg-Activities App-PushBottomUp`}>
